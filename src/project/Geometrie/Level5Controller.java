...
public class Level5Controller implements Initializable {
            ...
            next_button.setDisable(false);
             next_button.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
               ...
               public void handle(MouseEvent event) {
                   ...
                   try {
                       pane = FXMLLoader.load(getClass().getResource("/project/Newgame.fxml"));
                 ...
                 Alert a = new Alert(Alert.AlertType.NONE); 
                    ...
                    a.setAlertType(Alert.AlertType.INFORMATION); 
                        a.setContentText("More Level Comming Soon :)"); 
    ...
    private void go_back(ActionEvent event) throws IOException {
         AnchorPane pane1 =  FXMLLoader.load(getClass().getResource("/project/Newgame.fxml")); 
